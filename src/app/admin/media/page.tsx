...
import { Upload, X, Image as ImageIcon, Search, Sparkles, Wand2 } from 'lucide-react';
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                    {filteredMedia.map((item) => (
                        <div key={item.id} className="group relative aspect-square overflow-hidden rounded-[2rem] border border-gray-100 bg-white p-2 shadow-sm transition-all hover:shadow-2xl hover:shadow-gray-100 hover:-translate-y-1">
                            ...
                            <div className="absolute inset-2 flex flex-col justify-end rounded-[1.5rem] bg-gradient-to-t from-black/80 via-black/20 to-transparent p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="h-8 w-8 rounded-xl bg-white/10 flex items-center justify-center text-white backdrop-blur-md hover:bg-red-500 transition-colors">
                                        <X className="h-4 w-4" />
                                    </button>
                                </div>
                            </div>
